...
proc getType*(message:Message):Type = message.`type`
proc getTurnNumber*(event:Event):int = event.turnNumber
proc getSessionId*(message:ServerHandshake):string = message.sessionId

proc json2schema*(json_message:string):Message =
